...
public class ChefPanel extends Stage implements IAddOrderItemParentPanel
{
	...
	{
	    ArrayList<Order> pendingOrders = orderController.getAllOrdersByOrderStatus("Pending");
	    ordersTable.getItems().setAll(pendingOrders);
	}
